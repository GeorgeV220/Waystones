...
public final class Utils {
    ...
    private static final Waystones m = Waystones.getInstance();
    ...
    public static void debug(final JavaPlugin plugin, final Map<String, String> map, String... messages) {
        for (final String msg : messages) {
            Utils.printMsg(placeHolder("[" + plugin.getDescription().getName() + "] [Debug] [Version: " + plugin.getDescription().getVersion() + "] " + msg, map, false));
        }
    }
    ...
    public static boolean areTheseCirclesTouchEachOtherOrIntersect(Circle circle1, Circle circle2) {
        int distSq = (circle1.getX() - circle2.getX()) * (circle1.getX() - circle2.getX()) +
                (circle1.getZ() - circle2.getZ()) * (circle1.getZ() - circle2.getZ());
        int radSumSq = (circle1.getR() + circle2.getR()) * (circle1.getR() + circle2.getR());
    ...
    public static class Circle {
        ...
        public Circle(int x, int z, int r) {
            this.x = x;
            this.z = z;
            this.r = r;
        }
